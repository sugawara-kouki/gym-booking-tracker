...
export const poc = new Hono<{ Bindings: Bindings }>()

/**
 * PoC: Gmailからメール一覧を取得して返すテストエンドポイント
 * 認可とAPIの疎通確認に使用
 */
poc.get('/emails', async (c) => {
  try {
